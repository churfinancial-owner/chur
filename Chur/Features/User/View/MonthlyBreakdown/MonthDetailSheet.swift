...
struct MonthDetailSheet: View {
                ...
                VStack(spacing: 0) {
                    ...
                    VStack(spacing: 28) {
                        ...
                        if !monthlyFeeItems.isEmpty {
                            enhancedSection(title: String(localized: "Upcoming Fees"), icon: "creditcard.and.123", color: .red) {
                        ...
                        if !groupedBenefits.isEmpty {
                            enhancedSection(title: String(localized: "Redeemed Benefits"), icon: "sparkles", color: .green) {
    ...
    private var summaryDashboard: some View {
        HStack(spacing: 16) {
            summaryStatPill(label: String(localized: "Fees"), value: "$\(totalMonthlyFees)", color: .red)
            summaryStatPill(label: String(localized: "Redeemed"), value: "$\(totalMonthlySavings)", color: Color.churOlive)
        }
    }
