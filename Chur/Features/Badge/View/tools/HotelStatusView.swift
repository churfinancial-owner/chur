...
struct HotelStatusView: View {
    ...
    private var emptyState: some View {
        EmptyStatePlaceholder(icon: "bed.double", title: AppLocale.string("No hotel status yet"), subtitle: AppLocale.string("Add a card with hotel elite status benefits to see them here."))
    }
}
