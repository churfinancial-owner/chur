...
struct UserConfigurableRewardsSheet: View {
    ...
    private var headerSubtitle: String {
        ...
        case "us-bank-cash-plus":
            return AppLocale.string("Pick two 5% categories and one 2% everyday category. You can change these once per quarter.")
        case "citi-custom-cash":
            return AppLocale.string("Pick the one category where you spend the most — you'll automatically earn 5% there each billing cycle.")
        case "bofa-customized-cash":
            return AppLocale.string("Pick the one category where you spend the most — you'll automatically earn 3% there each billing cycle.")
        case "synchrony-venmo-visa":
            return AppLocale.string("Pick one 3% category and one 2% category where you spend the most — you'll automatically earn extra points there each billing cycle.")
        case "cardless-bilt-obsidian":
            return AppLocale.string("3X points on your choice of grocery or dining. Your 3X category choice remains in effect for the entire calendar year.")
        default:
            return AppLocale.string("Select a category for each reward tier.")
        }
    }
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            HStack {
                ...
                Text(reward.rate.formatAsRate(program: reward.rewardProgramName, compact: true))
