...
extension Font {
    ...
    // MARK: - Nano Labels (Size 9)
    static func churNanoBold() -> Font {
        .system(size: 9, weight: .bold, design: .rounded)
    }

    // MARK: - Missing Weight Variants
    static func churSmallMedium() -> Font {
        .system(size: 12, weight: .medium, design: .rounded)
    }

    // MARK: - Display / Counter
    static func churCounter() -> Font {
